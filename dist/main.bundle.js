...
var videoIds = ['my-player', 'my-player1'];
var videoOptions = {};
var players = [];

players = videoIds.map(function (id) {
	return (0, _video2.default)(id, videoOptions, function () {
		videoLinster(this);
	});
});

var videoLinster = function videoLinster(player) {
	_index2.default.play(player, {
		// disable: true
	}, players);
};
...
exports.default = {
	play: _index2.default,
	pause: _index4.default,
	progress: _index6.default,
	text: _index8.default
};
 ...
 */
var pauseMedia = function pauseMedia(player) {
    player.pause();
};
...
var operateOtherPlayers = function operateOtherPlayers(curPlayer, allPlayers, operateFn) {
    allPlayers = allPlayers || [];
    if (!operateFn) {
        operateFn = function operateFn() {};
    }
...
var play = function play(player, options, allPlayers) {
    options = options || {};
    if (options.disable) {
    ...
    player.on('ended', function () {
        operateOtherPlayers(player, allPlayers, function (item) {
...
// module
exports.push([module.i, ".custom-disable-play .vjs-tech, .disable-can-play .vjs-tech {\n  pointer-events: none; }\n\n.custom-disable-play .vjs-play-control, .disable-can-play .vjs-play-control {\n  pointer-events: none; }\n", ""]);
...
var pause = function pause(player, options) {
    options = options || {};
    if (options.disable) {
...
// module
exports.push([module.i, ".custom-disable-pause.vjs-playing .vjs-tech {\n  pointer-events: none; }\n\n.custom-disable-pause .vjs-play-control.vjs-playing {\n  pointer-events: none; }\n", ""]);
...
var progress = function progress(player, options) {
    options = options || {};
    if (options.disable) {
...
// module
exports.push([module.i, ".custom-disable-progress .vjs-progress-control {\n  pointer-events: none; }\n", ""]);
...
var setStyle = function setStyle(style, textBox) {
    if (style) {
        for (var i in style) {
...
var setClass = function setClass(className, textBox) {
    if (className) {
        textBox.className += ' ' + className;
    }
};

var text = function text(player, options) {
    options = options || {};
    var textBox = void 0,
        textBoxDom = void 0;
    if (options.htmlText) {
...
// module
exports.push([module.i, ".play-count-box {\n  height: 20px;\n  line-height: 18px;\n  position: absolute;\n  bottom: -20px;\n  width: 100%;\n  color: #fff;\n  background: #1E232C;\n  padding-left: 15px;\n  font-size: 12px; }\n  .play-count-box.once-tip {\n    color: #ffab37;\n    padding-left: 36px; }\n    .play-count-box.once-tip i {\n      position: absolute;\n      left: 13px;\n      width: 17px;\n      height: 17px; }\n", ""]);
